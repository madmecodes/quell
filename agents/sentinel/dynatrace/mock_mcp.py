...
class MockMCP:
    ...
    # in-memory record of the Sentinel agents' own run, for the Evaluator to query
    ...
    def get_agent_traces(self, incident_id: str) -> dict[str, Any]:
        """Sentinel observing itself: the agents' own run telemetry.

        In production this is execute_dql over Sentinel's own OTel spans in
