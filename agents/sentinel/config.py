...
Verified working for project sentinel-hack-2026:
...
GCP_PROJECT = os.environ.get("SENTINEL_GCP_PROJECT", "sentinel-hack-2026")
GCP_LOCATION = os.environ.get("SENTINEL_GCP_LOCATION", "global")
...
USE_LIVE_LLM = os.environ.get("SENTINEL_USE_LIVE_LLM", "false").lower() == "true"
